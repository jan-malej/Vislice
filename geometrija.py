...
class Vektor(Vektor):
    def __truediv__(self, skalar):
        return Vektor((1 / skalar) * self.x, (1 / skalar) * self.y)
# =====================================================================@002155=
# 7. podnaloga
...
class Premica(Premica):
    def projekcija(self, tocka):
        vektor_a = tocka - self.tocka
        skalar = (vektor_a * self.normala) / (self.normala * self.normala)
        a_crtica = self.normala * skalar
        b = tocka - a_crtica
        return Tocka(b.x, b.y)
# =====================================================================@002158=
# 10. podnaloga
...
class Premica(Premica):
    def presek(self, other):
        t1 = Vektor(self.tocka.x, self.tocka.y)
        t2 = Vektor(other.tocka.x, other.tocka.y)
        smerni2 = Vektor(other.normala.x, other.normala.y).rotacija(math.pi / 2)
        razlika = t1 - t2
        beta = (razlika * self.normala) / (smerni2 * self.normala)
        return other.tocka.translacija(smerni2 * beta)
# =====================================================================@002159=
# 11. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ5LCJ1c2VyIjo3MzU5fQ:1nh9PS:c2aC0ndTMHw8eNBDd1ce4CzI0r8'
        try:
            pass
        except:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTUwLCJ1c2VyIjo3MzU5fQ:1nh9PS:1pojoaz0ODNSFkQ_LbrUYy_5xn8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTUxLCJ1c2VyIjo3MzU5fQ:1nh9PS:dEbsnH6K-mEKUmNuyiCRtiLWXVk'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTUyLCJ1c2VyIjo3MzU5fQ:1nh9PS:P7G4biKbYIVkybO9jyr5KT9fXuY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTUzLCJ1c2VyIjo3MzU5fQ:1nh9PS:FzbAS4zakBe4C1zDG03KK9QaLN8'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTU0LCJ1c2VyIjo3MzU5fQ:1nh9PS:e1lrDNnR_Or5HcN3iX7nrNhM3Lg'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTU1LCJ1c2VyIjo3MzU5fQ:1nh9PS:ezTsfnMM3FVpKRi5fUb8BNmMbao'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTU2LCJ1c2VyIjo3MzU5fQ:1nh9PS:2A4yUx27AvVb8GIc-VZoMNS2MoU'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTU3LCJ1c2VyIjo3MzU5fQ:1nh9PS:T4Pe5YCTrU-4T6zRnhjX_FnEDFg'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTU4LCJ1c2VyIjo3MzU5fQ:1nh9PS:8bPYYebPQvYVHPOwJDUV_e701ec'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTU5LCJ1c2VyIjo3MzU5fQ:1nh9PS:ca0Zpzy2aMEcsGgIaPefUXJOwWU'
        try:
